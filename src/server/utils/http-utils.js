const { HttpResponse, JsonBodyType, StrictResponse } = require('msw');

/**
 * Receives a body and returns an HTTP response with the given body and status code 200.
 * @param {Object} body - The response body.
 * @returns {StrictResponse<JsonBodyType>} - The HTTP response.
 */
function ok(body) {
...
module.exports = { ok, badRequest, unauthorized };
